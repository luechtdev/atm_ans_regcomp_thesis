...
\graffito{Hier fehlt noch eine KURZE Vorstellung der jeweiligen Organe nach EUV/AEUV. Teils noch unvollständig (soweit Sinnvoll)}
...
Das \textit{ordentliche Gesetzgebungsverfahren} definiert seit dem Vertrag von Lissabon eine überarbeitete Version des Mitentscheidungsverfahrens \cite[Art. 294]{AEUV}, welches den Gesetzgebungsprozess gewisser Themenbereiche -- darunter auch Verkehrspolitik -- bestimmt. 

% Im Vergleich zu seinem Vorgänger findet dieses Gesetzgebungsverfahren nun in deutlich mehr Themenbereichen seine Anwendung. Zu den Anwendungsbereichen zählen unter anderem:
    % \begin{itemize}
    %     \item Verkehrspolitik
    %     \item Umweltpolitik
    %     \item Entwicklungspolitik
    %     \item Arbeitnehmerschutz
    %     \item Freizügigkeit
    %     \item etc.
    % \end{itemize}
    Es schreibt fest, auf welche Art und Weise Parlament, Rat und Kommission Verordnungen erlassen. 
    ...
    \graffito{Der Text ist noch alt. Der wird noch überarbeitet}
