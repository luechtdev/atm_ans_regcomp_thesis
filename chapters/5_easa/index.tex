...
\subsection{Aufgaben der EASA}
    ...
    Im Rahmen der Verordnungen \vo{VO}{EG}{216/2008} -- und später \vo{VO}{EU}{2018/1139} -- wurden die Aufgaben, der innere Aufbau, die Arbeitsweise und die Finanzvorschriften der Agentur dargelegt.
...
>
  ...
  <pkg:part pkg:name="/customXml/item4.xml"> [...]
    ...
    \end{lstlisting}
    \caption{Beispiel der \acsfont{OPC} Strukturierung einer \ac{EAR}}
    \label{fig:opcear}
\end{figure}
