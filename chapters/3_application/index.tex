...
% \begin{quote}
% \textcolor{red}{Technisch relevante Aspekte und Eigenschaften der regulativen Anforderungen, die für eine funktionierende Impactanalyse verfügbar sein müssen.
% Einfach gesagt: Welche Informationen brauchen wir? (Zusätzlich: Bei welchen Informationen wäre es schön, sie zu haben?)
% }
% \end{quote}
...
% \begin{quote}
% \textcolor{red}{Compliance Matrix als Endergebnis des Prozesses, Auflistung aller aktuellen Compliance Angaben. Auch kurze Modellierung}
% \end{quote}
